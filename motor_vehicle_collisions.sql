...
CREATE TABLE `collisions` (
  ...
  `public_property_damage_id` int DEFAULT NULL,
  PRIMARY KEY (`collision_id`),
  KEY `public_property_damage_id` (`public_property_damage_id`),
  CONSTRAINT `collisions_ibfk_1` FOREIGN KEY (`public_property_damage_id`) REFERENCES `public_property_damage` (`public_property_damage_id`)

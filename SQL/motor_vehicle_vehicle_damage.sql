...
CREATE TABLE `vehicle_damage` (
  ...
  `vehicle_damage` varchar(255) DEFAULT NULL,
  `point_of_impact` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`damage_id`),
  KEY `vehicle_id` (`vehicle_id`),
  CONSTRAINT `vehicle_damage_ibfk_1` FOREIGN KEY (`vehicle_id`) REFERENCES `vehicle` (`vehicle_id`)
